...
// Distance calculations still use full detailed path for accuracy
...
async function closeSpecificTrailSimplified() {
    try {
        ...
        console.log(`   buffer/area calculations to handle very large trails.\n`)
        console.log(`   ✓ Distance: Uses full detailed path (accurate)`)
        ...
        console.log(`✓ Retrieved ${trailPoints.length.toLocaleString()} trail points\n`)
        ...
        console.log(`✓ Simplified to ${simplifiedPath.length.toLocaleString()} points`)
        console.log(`  Reduction: ${Math.round((1 - simplifiedPath.length / validPoints.length) * 100)}%`)
        console.log(`  This simplified path will be used for area/overlap calculations\n`)
        ...
        // Build detailed path (LINESTRING M with timestamps) - for accurate distance
        console.log(`Building detailed path (LINESTRING M) - for distance calculations...`)
        ...
        console.log(`✓ Detailed path validated (${validPoints.length.toLocaleString()} points)`)

        // Build simplified path (LINESTRING) - for buffer/area calculations
        console.log(`Building simplified path (LINESTRING) - for buffer/area calculations...`)
        ...
        console.log(`✓ Simplified path validated (${simplifiedPath.length.toLocaleString()} points)\n`)

        // Call close_trail_simplified RPC function
        console.log(`Calling close_trail_simplified function...`)
        console.log(`This will:`)
        console.log(`  1. Calculate distance using detailed path (${validPoints.length.toLocaleString()} points)`)
        ...
        if (result.metrics) {
            console.log(`\nCalculated Metrics:`)
            console.log(`  Distance: ${result.metrics.trail_distance}m (from full detailed path)`)
