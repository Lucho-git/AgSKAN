...
// NOTE (2026-09-09): rock & rock pile were listed here and lost their
// background disc — removed so the rocks render with a normal background
// circle again like the other markers.
