<script lang="ts">
    ...
    const SMS_FUNCTION = "https://hmxxqacnzxqpcheoeidn.supabase.co/functions/v1/send-sms"
...
{#if show}
    <div class="modal modal-open" on:click={handleClose}>
        <div class="modal-box max-w-md" on:click|stopPropagation>
            ...
            <div class="mb-4 p-3 rounded-lg bg-base-200 text-sm">
                ...
                {/if}
                <br />
                <span class="text-contrast-content/40 text-xs">Sent from agskan alpha tag</span>
            </div>
            ...
            {:else}
                <div class="form-control mb-4">
                    ...
                    ></textarea>
                    <label class="label">
                        <span class="label-text-alt text-contrast-content/50">{charCount}/500</span>
                        {#if error}
