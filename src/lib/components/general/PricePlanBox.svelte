<!-- src/lib/components/general/PricePlanBox.svelte -->
<script lang="ts">
  ...
  <div class="flex h-full flex-col">
    ...
    {#if plan.id !== "free"}
      <div class="mt-4 flex items-center justify-center">
        <button
          class="hover:from-secondary-focus hover:to-accent-focus btn btn-outline btn-sm bg-gradient-to-r from-secondary to-accent text-secondary-content"
    ...
    <div class="mt-6 flex flex-1 flex-row items-center pt-4">
      ...
      {:else}
        <a
          ...
          class="hover:from-secondary-focus hover:to-accent-focus btn btn-outline mx-auto w-[80%] bg-gradient-to-r from-secondary to-accent text-secondary-content"
        >
          {callToAction}
        </a>
      {/if}
