<!-- src/lib/components/general/FloatingChat.svelte -->
<script>
...
<div class="fixed bottom-8 right-8 z-50 flex flex-col items-end">
  {#if isOpen}
    <div class="card mb-4 w-80 bg-base-100 shadow-xl">
      <div class="card-body">
  ...
  <button class="btn btn-circle btn-primary btn-lg" on:click={toggleChat}>
