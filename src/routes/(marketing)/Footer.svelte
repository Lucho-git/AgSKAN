<script>
  // Add any necessary imports or component logic here
</script>

<div class="flex-grow"></div>
<div class="bg-base-200">
  <div class="mx-auto max-w-[1000px] border-t border-base-300"></div>
  <footer
    class="footer place-content-center gap-x-48 p-16 text-base lg:gap-x-64 xl:gap-x-96"
  >
    <nav class="flex items-center justify-center pt-3">
      <div class="flex items-center">
        <svg
          ...
          class="mr-4 fill-current text-base-content"
        >
          <g
        ...
        <div class="flex flex-col text-center">
          <p class="text-sm font-bold text-base-content">
            SKAN Farming Logistics Pty Ltd
          </p>
        ...
        <div class="grid grid-flow-col gap-6">
          ...
          >
            <svg
              ...
              height="28"
              viewBox="0 0 24 24"
              class="fill-current text-base-content transition duration-300 ease-in-out hover:scale-110 hover:text-primary"
            >
              <path
          ...
          <a href="mailto:ryan@skanfarming.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="28"
              height="28"
