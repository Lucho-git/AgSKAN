  ...
  <div class="section-container py-20">
    {#if mounted}
      ...
      <div class="mx-auto grid max-w-3xl gap-6 md:grid-cols-2">
        ...
        <!-- Free card -->
        <div class="relative flex flex-col rounded-xl border-2 border-base-content bg-base-100 p-6 shadow-xl" in:animationDelay={100}>
          <div class="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-base-content px-4 py-1 text-xs font-bold uppercase text-base-100 shadow-md">
            Start Here
          </div>

          <h3 class="mt-2 font-sans text-xl font-bold text-contrast-content">Free Account</h3>
          <div class="mt-3 flex items-end">
            <span class="text-4xl font-bold text-contrast-content">{CURRENCY_SYMBOL}0</span>
          ...
          <ul class="mt-4 space-y-2 text-sm">
            ...
            <li class="flex items-center gap-2">
              <Check size={16} style="color: #22c55e;" />
              <span class="text-contrast-content">Create paddocks & drop pins</span>
            </li>
            <li class="flex items-center gap-2">
              <Check size={16} style="color: #22c55e;" />
              <span class="text-contrast-content">Test every feature — no limits</span>
            </li>
          </ul>
        ...
        <!-- Pro card -->
        <div class="relative flex flex-col rounded-xl border border-base-300 bg-base-100 p-6 shadow-md" in:animationDelay={200}>
          <div class="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-secondary px-4 py-1 text-xs font-bold uppercase text-secondary-content shadow-md">
            1 Month Free Trial
          </div>

          <h3 class="mt-2 font-sans text-xl font-bold text-contrast-content">Pro — Team Plan</h3>
          <div class="mt-3 flex items-center justify-between">
            <div class="flex items-end">
              <span class="text-4xl font-bold text-contrast-content">{CURRENCY_SYMBOL}{totalMonthly}</span>
              <span class="mb-0.5 ml-1 text-contrast-content/60">/mo</span>
            </div>
            <!-- Inline team size selector -->
            <div class="flex items-center gap-2 rounded-lg bg-base-200 px-2 py-1">
              <button
          ...
          <ul class="mt-4 space-y-2 text-sm">
            <li class="flex items-center gap-2 rounded-lg border border-secondary/30 bg-secondary/5 px-2 py-1.5">
              <Check size={16} style="color: #22c55e;" />
              <span class="font-semibold text-contrast-content">Track {machineCount} operator{machineCount > 1 ? "s" : ""} in real time</span>
            </li>
            <li class="flex items-center gap-2">
              <Check size={16} style="color: #22c55e;" />
              <span class="text-contrast-content">Background trails & coverage recording</span>
            </li>
            <li class="flex items-center gap-2">
              <Check size={16} style="color: #22c55e;" />
              <span class="text-contrast-content">Rock picking paths & offline replay</span>
            </li>
          </ul>
