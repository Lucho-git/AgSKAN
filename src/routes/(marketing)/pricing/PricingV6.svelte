  ...
  <div class="section-container py-20">
    {#if mounted}
      <div in:animationDelay={0}>
        <h2
          class="mb-4 text-center font-sans text-3xl font-bold text-contrast-content md:text-4xl"
        >
      ...
      >
        ...
        >
          ...
          <div class="text-center md:text-left">
            <div
              class="mb-2 inline-block rounded-full bg-secondary px-3 py-1 text-xs font-bold uppercase text-secondary-content shadow-md"
            >
              1 Month Free
            </div>
            <h3 class="font-sans text-2xl font-bold text-contrast-content">
              AgSKAN Pro
            </h3>
          ...
          <div class="flex flex-col items-center gap-3">
            <div class="flex items-end">
              <span class="text-5xl font-bold text-contrast-content"
            ...
            <!-- Team size +/- -->
            <div
              class="flex items-center gap-3 rounded-lg bg-base-200 p-1.5 shadow-md md:p-2"
            >
              <span
            ...
            {#if machineCount === 1}
              <div
                class="flex items-center justify-center gap-1.5 text-xs text-warning"
              >
        ...
        >
          <div>
            ...
            <p class="text-sm text-contrast-content/60">
              1 operator, no credit card, no expiry.
            </p>
          </div>
          <button
